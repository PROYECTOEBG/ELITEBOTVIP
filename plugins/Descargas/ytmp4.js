...
if (!args[0]) return conn.reply(m.chat, `*Lo usaste mal:*\nEjemplo: .ytmp4 https://youtu.be/u0uMlNJneEY?si=qyc_d5UgpraXCSIo`,  m)
let youtubeLink = '';
...
await await conn.sendMessage(m.chat, { video: { url: dl_url }, fileName: `${ttl}.mp4`, mimetype: 'video/mp4', caption: `𝙑𝙞𝙙𝙚𝙤 𝙙𝙚𝙨𝙘𝙖𝙧𝙜𝙖𝙙𝙤 ✅`, thumbnail: await fetch(yt.thumbnail) }, { quoted: m })
} catch (E1) {
