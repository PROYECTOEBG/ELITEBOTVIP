import fg from 'api-dylux';
 ...
 let texto = `@${m.sender.split`@`[0]} 𝘦𝘯𝘷𝘪𝘢𝘯𝘥𝘰 𝘦𝘭 𝘷𝘪́𝘥𝘦𝘰 𝘴𝘪𝘯 𝘮𝘢𝘳𝘤𝘢 𝘥𝘦 𝘢𝘨𝘶𝘢 , 𝘦𝘴𝘱𝘦𝘳𝘢 𝘱𝘰𝘳 𝘧𝘢𝘷𝘰𝘳 ... 💯` 
 try { 
 ...
 let desc1 =  `𝘎𝘳𝘢𝘤𝘪𝘢𝘴 𝘱𝘰𝘳 𝘭𝘢 𝘦𝘴𝘱𝘦𝘳𝘢, 𝘵𝘦𝘯 𝘵𝘶 𝘷𝘪́𝘥𝘦𝘰 𝘴𝘪𝘯 𝘮𝘢𝘳𝘤𝘢 𝘥𝘦 𝘢𝘨𝘶𝘢. ✅` 
 await conn.sendMessage(m.chat, { video: { url: dataF.play }, caption: desc1 }, { quoted: m })   
 } catch (e1) { 
 try { 
 const tTiktok = await tiktokdlF(args[0]) 
 //let desc2 = `🔗 *Url:* ${tTiktok.video}`     
 let desc2 =  `𝘎𝘳𝘢𝘤𝘪𝘢𝘴 𝘱𝘰𝘳 𝘭𝘢 𝘦𝘴𝘱𝘦𝘳𝘢, 𝘵𝘦𝘯 𝘵𝘶 𝘷𝘪́𝘥𝘦𝘰 𝘴𝘪𝘯 𝘮𝘢𝘳𝘤𝘢 𝘥𝘦 𝘢𝘨𝘶𝘢. ✅` 
 await conn.sendMessage(m.chat, { video: { url: tTiktok.video }, caption: desc2 }, { quoted: m })       
 } catch (e2) { 
 try { 
 let p = await fg.tiktok(args[0])  
 //let te = `*USUARIO:* ${p.author || 'Indefinido'}` 
 let te =  `𝘎𝘳𝘢𝘤𝘪𝘢𝘴 𝘱𝘰𝘳 𝘭𝘢 𝘦𝘴𝘱𝘦𝘳𝘢, 𝘵𝘦𝘯 𝘵𝘶 𝘷𝘪́𝘥𝘦𝘰 𝘴𝘪𝘯 𝘮𝘢𝘳𝘤𝘢 𝘥𝘦 𝘢𝘨𝘶𝘢. ✅` 
 ...
 let cap =  `𝘎𝘳𝘢𝘤𝘪𝘢𝘴 𝘱𝘰𝘳 𝘭𝘢 𝘦𝘴𝘱𝘦𝘳𝘢, 𝘵𝘦𝘯 𝘵𝘶 𝘷𝘪́𝘥𝘦𝘰 𝘴𝘪𝘯 𝘮𝘢𝘳𝘤𝘢 𝘥𝘦 𝘢𝘨𝘶𝘢. ✅` 
 await conn.sendMessage(m.chat, { video: { url: url}, caption: cap }, { quoted: m })   
 } catch { 
 throw `No se pudo descargar este video, asegúrate que sea el link correcto e intenta de nuevo.` 
 }}}}} 
