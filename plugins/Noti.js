...
//    const htextos = `${text ? text : '𝕷𝖔𝖇𝖔-𝕭𝖔𝖙-𝕸𝕯 (∩_∩)'}`;
    if ((isMedia && quoted.mtype === 'imageMessage') && htextos) {
      ...
      await conn.relayMessage(m.chat, {extendedTextMessage: {text: ``, ...{contextInfo: {mentionedJid: users, externalAdReply: {thumbnail: imagen1, sourceUrl: global.md}}}}}, {});
    }
  }
};
handler.command = /^(hidetag|noti|nnn|notify|aviso|avisos|rp)$/i;
handler.group = true;
handler.admin = true;
